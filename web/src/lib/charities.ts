...
// Static mirror of the backend catalog in `src/pact/charities.py`. The packaged
// desktop app fetches the live list from the sidecar (`GET /api/charities`); the
// public web funnel has no backend, so it reads this bundled copy directly — the
// stamps already ship under `public/charity-stamps/`. Keep this in sync with
// charities.py (id / name / donation_url / category / description / stamp).
export const CHARITY_CATALOG: Charity[] = [
  {
    ...
    description:
      "Founded by primatologist Jane Goodall, it protects chimpanzees and their habitats while empowering local communities to conserve the natural world.",
  ...
  },
  {
    ...
    description:
      "A reforestation nonprofit that plants one tree for every dollar donated, restoring forests across North America, Africa, Asia, and beyond.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Brings clean and safe drinking water to people in developing countries, with 100% of public donations funding water projects in the field.",
    default_amounts: [50, 100, 200],
  ...
  },
  {
    ...
    category: "wildlife_conservation",
    description:
      "Works in nearly 100 countries to protect endangered species and the wild places they need to survive.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Delivers emergency medical care to people caught in conflict, disaster, and epidemics — independent of politics, religion, or borders.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    category: "wildlife_conservation",
    description:
      "Protects ecologically vital lands and waters around the world to safeguard biodiversity and confront the climate crisis.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "The largest U.S. hunger-relief organization, supplying meals to tens of millions of people through a nationwide network of food banks.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Gives children in the U.S. and around the world a healthy start, the opportunity to learn, and protection from harm.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    category: "childrens_welfare",
    description:
      "Supports UNICEF's work delivering health care, nutrition, clean water, and education to children in more than 190 countries.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Provides emergency assistance, disaster relief, and roughly 40% of the nation's blood supply across the United States.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Pushes for the technologies and policies needed to cut climate-warming pollution and reach a zero-emissions energy system.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Runs the country's largest no-kill animal sanctuary and works to end the killing of dogs and cats in America's shelters.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Funds and distributes long-lasting insecticide-treated bed nets to protect families from malaria in the highest-need regions.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    category: "education",
    description:
      "Lets anyone fund classroom project requests posted by public-school teachers across the United States.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
  ...
  },
  {
    ...
    description:
      "Co-founded by Malala Yousafzai, it champions every girl's right to twelve years of free, safe, quality education.",
    default_amounts: [50, 100, 200],
    checkout_kind: "other",
